...
function q_a() {
    ...
    <tr>
        ...
        <td>
            ...
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span></div>
            <p>you should get one if you are doing laser cut.</p>
    ...
    <tr>
        ...
        <td>
            ...
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span></div>
            <p>the best auxiliary equipment for my atomstack a5 pro+</p>
    ...
    <tr>
        ...
        <td>
            ...
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span></div>
            <p>finnaly received it after 2 weeks, now i can start my wood projects with the sculpfun s10</p>
    ...
    <tr>
        ...
        <td>
            ...
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span></div>
            <p>Working for may sculpfun s10.</p>
